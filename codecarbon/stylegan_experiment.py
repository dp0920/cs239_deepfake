...
def run_stylegan2_ada_pytorch_script(seeds):
    ...
    subprocess.run([
        "python", "generate.py", "--outdir=out", "--trunc=1", "--seeds="+seeds,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Measure emissions for StyleGAN2-ADA-PyTorch generation.")
    parser.add_argument("seeds", type=str, help="Seeds for image generation (e.g., '1-100').")
    args = parser.parse_args()
    print("Starting Deepfake Energy Measurement...")

    # Measure StyleGAN2
    measure_emissions(run_stylegan2_ada_pytorch_script, "StyleGAN2-ADA-PyTorch-Generation", args.seeds)
